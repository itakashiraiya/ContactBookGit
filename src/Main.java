...
public class Main {
    ...
    public static final String PHONE_NUMBERS_EQUAL = "There are contacts that share phone numbers.";
    public static final String PHONE_NUMBERS_NOT_EQUAL = "All contacts have different phone numbers.";
    ...
    private static void checkPhoneCollision(ContactBook cBook) {
        if (cBook.hasRepeatedNumbers()) {
            System.out.println(PHONE_NUMBERS_EQUAL);
        }
        else System.out.println(PHONE_NUMBERS_NOT_EQUAL);
    }
}
